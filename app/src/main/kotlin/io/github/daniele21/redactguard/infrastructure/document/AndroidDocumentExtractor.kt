...
internal data class ExtractedDocument(val descriptor: DocumentDescriptor, val segments: List<DocumentSegment>)
...
internal class DocumentExtractionException(val code: DocumentExtractionFailureCode) : IOException("Document extraction failed: $code")
...
internal class AndroidDocumentExtractor(
    ...
    private fun mapParserFailure(errorType: String): DocumentExtractionFailureCode = when (errorType) {
