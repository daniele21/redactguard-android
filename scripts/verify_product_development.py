...
DEPTHS = ["product_none", "product_local", "product_feature", "product_strategic"]
...
def main() -> int:
    ...
    if config:
        ...
        if config.get("applicable") is True:
            ...
            if not isinstance(post_release, dict) or not isinstance(post_release.get("required_when_material"), bool):
