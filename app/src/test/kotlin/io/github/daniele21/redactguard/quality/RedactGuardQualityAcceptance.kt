...
internal data class QualityGateFailure(
    val code: QualityGateFailureCode,
    val typeId: String? = null,
)

internal data class QualityAcceptanceReport(
    val accepted: Boolean,
    val failures: List<QualityGateFailure>,
)
...
internal object RedactGuardQualityAcceptanceGate {
    fun evaluate(
        policy: QualityAcceptancePolicy,
        score: QualityScore,
