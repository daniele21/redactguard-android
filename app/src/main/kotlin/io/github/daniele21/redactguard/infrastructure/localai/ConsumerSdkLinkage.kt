...
/**
 * Compile-time proof that RedactGuard receives the public Consumer inference/control-plane/readiness
 * API and Binder client from the externally published `consumer-android` artifact rather than from
 * a Harness source checkout.
 */
