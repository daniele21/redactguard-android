...
internal object ProductFailureProjector {
    ...
    private fun copyFor(kind: ProductFailureKind): ErrorCopy =
        when (kind) {
            ...
            ProductFailureKind.HOST_PROCESS_LOST -> ErrorCopy("AI locale interrotta", "Il processo dell’AI locale è stato interrotto durante l’analisi. Riconnetti Local AI Harness e riavvia l’analisi; nessun risultato parziale è stato conservato.")
