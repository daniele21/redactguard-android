...
`io.github.daniele21.localllm:consumer-android:0.1.0-alpha.3`
...
The Harness publication workflow must validate manifest/checksum/public ABI identity and prove unauthenticated external compilation before a version is considered available to RedactGuard. Repository tests do not substitute for the final same-signer two-APK physical evidence.
